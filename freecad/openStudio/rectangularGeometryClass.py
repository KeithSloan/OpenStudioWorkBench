...
class RectangularGeometryClass(BaseClass):
	def __init__(self, obj):
		super().__init__(obj, "RectanglarGeometry")
		self.initRectangularGeometry()
		#self.sketch = None
				
	def initRectangularGeometry(self):
		print(f"Init RectangularGeometry Class")
	...
	def calcShape(self):		# Called from onChange in BaseClass
		# ToDo Update for Rectangular Geometry
		import Part
		print(f"PlanarGeometry calcShape")
